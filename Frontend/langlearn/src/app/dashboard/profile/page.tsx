...
export default function Profile() {
  ...
  <div className="justify-between" style={{ backgroundImage: "url('../../../assets/b1.jpg')" }}>
...
<form className="bg-[#D9D9D9] border-4 w-172 h-1/2 p-4 rounded-lg ">
 <div className="flex ">
   ...
   <div className="mb-4" style={{ width: "250px", height: "200px" }}>
        <Image src = {image} alt="Form Image" className="w-full h-auto rounded-lg" />
      </div>
...
<p className="font-bold">My Quiz Result</p>
  ...
  <div className="flex">
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white ">S</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">M</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">T</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">W</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">Th</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">F</div>
      <div className="w-10 h-8 bg-[#0c5e76] rounded-full flex justify-center items-center text-white">Sa</div>
    </div>
</form>
 </div>
